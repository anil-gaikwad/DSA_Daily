...
# and one square horizontally, or two squares horizontally and one square vertically (with both forming 
# the shape of an L). The possible movements of chess knight are shown in this diagaram:
...
# Page: 60Given an integer n, return how many distinct phone numbers of length n we can dial.
# You are allowed to place the knight on any numeric cell initially and then you
# should perform n - 1 jumps to dial a number of length n. All jumps should be valid knight jumps.
...
##########################  11. Minimum Cost to Cut a Stick ########################## 

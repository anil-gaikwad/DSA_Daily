...
# integers within the 32-bit signed integer range: [−231, 231 − 1]. For this problem, if the quotient is strictly greater than 231 - 1, 
...
########################## 3. Most Beautiful Item for Each Query ########################## 
...
########################## 4. Minimum Absolute Sum Difference ########################## 
